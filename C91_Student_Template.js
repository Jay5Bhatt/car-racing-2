...
function add() {
	...
	function onload (uploadBackground);
	background_imgTag.src = background_image;   // load image
	function load(background_image);
	...
	function onload (uploadcar1);
	car1_imgTag.src = car1_image; 
	function load (car1_image);  // load image
	...
	function onload (uploadcar2);
	car2_imgTag.src = car2_image;   // load image
	function load(car2_image);
}
